# Generated by Django 5.0.3 on 2024-03-20 23:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_price', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='Цена подписки за месяц')),
                ('semi_annual_price', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='Цена подписки за полгода')),
                ('annual_price', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='Цена подписки за год')),
            ],
            options={
