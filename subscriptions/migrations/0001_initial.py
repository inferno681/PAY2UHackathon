    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promocode', models.CharField(blank=True, default='', max_length=13, null=True, validators=[django.core.validators.RegexValidator(message='Промокод содержит недопустимые символы', regex='^[A-Z0-9]+$')], verbose_name='Промокод')),
